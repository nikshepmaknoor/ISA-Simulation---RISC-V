...
public class Processor {
	...
	public Processor()
	{
		...
		IFUnit = new InstructionFetch(this, IF_EnableLatch, IF_OF_Latch, EX_IF_Latch, OF_EX_Latch);
		...
		RWUnit = new RegisterWrite(this, MA_RW_Latch, IF_EnableLatch, OF_EX_Latch, IF_OF_Latch,EX_MA_Latch);
	}
